...
parser.add_argument('--data', type=str, help='/content/mtunet_sea2/FSL_data/seadata', required=True)
parser.add_argument('--split', type=str, help='/content/mtunet_sea2/data/data_split/seas', required=True)
...
def get_split(cls, phase):
    ...
    for cl in cls:
        ...
        move(cl, phase)
    make_csv(record, f"/content/mtunet_sea2/data/data_split/seas/{phase}")
